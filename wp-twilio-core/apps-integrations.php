...
function apps_tab_content( $tab, $page_url ) {
	...
	?>
		...
		<h3 class="apps"><?php esc_html_e( 'Addons & Integrations', 'wp-twilio-core' ); ?></h3>
		<?php if ( wtc_fs()->is_not_paying() ) {
        ?>
		<a href="<?php 
        echo esc_url( wtc_fs()->get_upgrade_url() );
        ?>" class="button-primary wpsms" ><?php esc_html_e( 'Upgrade to Pro', 'wp-twilio-core' ); ?></a>
		<?php esc_html_e( 'Or', 'wp-twilio-core' ); ?>
		<?php }
        ?>
		<a href="https://checkout.freemius.com/?mode=dialog&plugin_id=6291&plan_id=10264&public_key=pk_704158bd6c7b5ee3c81af36e1829d&name=WP+SMS+BUNDLE&licenses=1&trial=0billing_cycle=annual#!#https:%2F%2Fwww.wpsms%2Fpricing%2F" class="button-primary wpsms bundle" target="_blank"><?php esc_html_e( 'Get Everything bellow for $49 Only!', 'wp-twilio-core' ); ?></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-product-10.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-marketing.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-contactform7.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-auctions.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-bulk.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-bookings.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		<p>Integrate SMS notifications with WooCommerce Bookings plugin. Send SMS when there is a new booking.</p>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-wpjobamanager.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-givewp.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-adforest-1.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-downloadlink.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-vantage.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-classipress.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		<p>Send instant SMS to your sellers when they are contacted via their listings contact form.</p>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-eesms.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
		...
		<img src="<?php echo esc_url( plugins_url( 'assets/images/wpsms-edd.png', __FILE__ ) ); ?>" class="attachment-download-grid-thumb size-download-grid-thumb wp-post-image" width="1200" height="600"></a>
